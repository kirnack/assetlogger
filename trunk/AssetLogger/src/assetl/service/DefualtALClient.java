...
/**
 * A Default Implemenation of a
 * ALClient to the Server
 */
public class DefualtALClient implements ALClient
{
    ...
    */
   public DefualtALClient(int pBufferSize, String pHost, int pPort, String pBaseURL)
   {
      try
      {
